    ...
    <div  className={styles.midheadcontainer} >
      ...
      <div className={styles.midheadright} >
        ...
        <div className={styles.midheadrighttop}>
          <span style={{ zIndex:'1' , fontSize:'25px' , fontWeight:'400'}} ><span id='student' style={{ fontSize:'30px' , fontWeight:'700' , color:'white'}} > <span style={{ width:'262px', height:'7px' , zIndex:'1' ,  display: 'inline-block' , backgroundColor:'yellow' ,top:'125px' , opacity:'0.9' , position:'absolute'}}  ></span> <span style={{zIndex:'5', textShadow: '1px 1px 1px black' , position:'relative'}}  > Software Engineer</span> </span> passionate about solving problems related to</span> <span style={{backgroundColor:'blue', color:'white'}} >Distributed Systems</span> <span style={{ fontSize:'25px' , fontWeight:'400'}} >and</span> <span style={{backgroundColor:'blue', color:'white'}} >Software</span> 
       
        </div>
        <div className={styles.smya}  >
          AALACHI MOHAMED
        </div>
